...
<html>
	...
	<body onscroll="navwidabt()">
		...
		<nav id="nav" onmouseover="swapcolorabt1()" onmouseout="swapcolorabt2()" class="bigscreen">
		...
		<div class="col-12 teamdiv">
			<div class="col-3 off-4-5 xs-10 xsoff-1">
			...
			<div class="col-3 off-0-5  xs-10 xsoff-1">
			...
			<div class="col-3 off-1 xs-10 xsoff-1">
